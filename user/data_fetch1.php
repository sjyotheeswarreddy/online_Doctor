...
$columns = array(
 ...
 $query = "SELECT * from  appointment WHERE PatientName='$name1' AND";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $sub_array[] = '<div style="text-align:center;color:black">' . $row["meeting_link"] . '</div>';
    ...
    // $sub_array[] = '<center><a href="edit-appointment.php?id='.$row["id"].'"><i class="fas fa-edit fa-2x" id="update"></i></a></center>';
