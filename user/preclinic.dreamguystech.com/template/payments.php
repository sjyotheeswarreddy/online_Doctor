...
<tbody>
                                ...
                                $query = mysqli_query($con, "SELECT * from  payments where PatientName='$admin'");
                                while ($data = mysqli_fetch_array($query)) {

                                    $sno =$data['id'];
                                    $payid = $data['payment ID'];
                                    $name = $data['PatientName'];
                                    $paytype = $data['Payment Type'];
                                    $pdate = $data['Paid Date'];
                                    $pamount = $data['Paid Amount'];
                                ...
                                ?>
                                    <tr style="border-bottom: 1px solid black;">
                                        ...
                                        <td style="text-align: center;background-color:white"><?php echo $payid; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $name; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $paytype; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $pdate; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $pamount; ?></td>
