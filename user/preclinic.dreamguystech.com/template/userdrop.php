...
elseif (isset($_POST['submit1'])) {
    ...
    $q2 = mysqli_query($con, "INSERT INTO register(Username,EmailAddress,Password,UserMobile,role,Hospital_Name,Qualification,Experience,Address,Pincode,image) VALUES ('$Username','$EmailAddress','$Password','$UserMobile','$role','$hsname','$quali','$exper','$addr','$pcode' ,'$img')");
...
elseif (isset($_POST['submit2'])) {
    ...
    $exper='';
    $hsname='';
    $q3 = mysqli_query($con, "INSERT INTO register(Username,EmailAddress,Password,UserMobile,role,Address,Pincode,Qualification,Experience,Hospital_Name,image) VALUES ('$Username','$EmailAddress','$Password','$UserMobile','$role','$addr','$pcode','$quali','$exper','$hsname','$img')");
...
<label for="cars"  >Choose Role :</label><br>
        <select name="" id="roles" onchange="changeRole()" style="height: 40px; width:100% ; ">
...
<div class="m-t-20 text-center">
<input type="submit" name="submit1"  style="color:white; background-color:#009EFB;border-radius: 20px; width: 100px;height: 40px;">
</div>
</form>
...
<div class="m-t-20 text-center">
<input type="submit" name="submit2"  style="color:white; background-color:#009EFB;border-radius: 20px; width: 100px;height: 40px;">
</div>
</form>
