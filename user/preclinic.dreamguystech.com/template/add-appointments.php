...
$sql = mysqli_query($con, "INSERT INTO  appointment(PatientName,Patient_Email,PatientPhone,Date,Time, Comments,meeting_link,status) VALUES('$Patient_Name','$Patient_Email','$PatientPn','$Date','$Time','$Message','$meetlink','$status')");
if ($sql) {
