...
<label class="focus-label">Old Password</label><br>
  ...
  <input type="password" name="Oldpassword" autocomplete="current-password" required="" id="id_password"style="width: 99%;height: 50%;border: 1px solid;border-radius: 10px;">
  <i class="far fa-eye one" id="togglePassword" style="margin-left: -7%; cursor: pointer;"></i>
...
<input type="password"  name="newpassword" autocomplete="current-password" required="" id="id_password1"style="width: 99%;height: 50%;border: 1px solid;border-radius: 10px;">
...
<input type="password" name="confirmnewpassword" autocomplete="current-password" required="" id="id_password2"style="width: 99%;height: 50%;border: 1px solid;border-radius: 10px;">
