...
if (isset($_POST['submit'])) {
    ...
    $exper='';
    $hsname='';
    $q1 = mysqli_query($con, "INSERT INTO register(Username,EmailAddress,Password,UserMobile,role,Address,Pincode,Qualification,Experience,Hospital_Name,image) VALUES ('$Username','$EmailAddress','$Password','$UserMobile','$role','$addr','$pcode','$quali','$exper','$hsname','$img')");
