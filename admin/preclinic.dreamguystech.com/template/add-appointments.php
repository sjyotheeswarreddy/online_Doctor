...
$sql = mysqli_query($con, "INSERT INTO  appointment(Appointment_ID,Patient_Name,Department,Doctor,Dte,Tie, Patient_Email,PatientPn,Mesage) VALUES('$Appointment_ID','$Patient_Name','$Department','$Doctor','$Date','$Time','$Patient_Email','$PatientPn','$Message')");
...
<li>
<a href="appointments.html"><i class="fa fa-calendar"></i> <span>Appointment List</span></a>
 </li>
<!--<li>
...
<li>
	<a href="form-horizontal.html"><i class="fa fa-medkit"></i> <span>Prescription Page</span></a>
	 </li>
	 ...
	 <li class="submenu">
		...
		<ul style="display: none;">
			<li>
				...
				<a href="add-appointment.html"><i class="fa fa-envelope"></i> <span>Add</span></a>
				</li>

				<li>
					<a href="appointview.php"><i class="fa fa-eye"></i> <span>view</span></a>
					</li>
					<!--<li class="submenu">
...
<input class="form-control" type="text" name="PatientPn">
</div>
</div>
</div>
<div class="form-group">
...
<a href="appointments.html" class="btn btn btn-primary btn-rounded float-center" name="submit"> submit </a>
</form>

    <!--<input type="submit" class="btn btn btn-primary btn-rounded float-center" name="submit"> <a> href="appointments.html" > submit </a>-->
