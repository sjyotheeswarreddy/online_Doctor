...
$phonenumber = mysqli_real_escape_string($con, $_POST['phonenumber']);
 ...
 $sql ="UPDATE register SET Username='$name',EmailAddress='$email',UserMobile='$phonenumber',role='$role', Hospital_Name='$hname',   Qualification='$qual',Experience='$exp',Address='$add',Pincode='$pincode' WHERE id='$sno'";
...
<div class="form-group">
<label>Email</label>
<input class="form-control" type="email" name="email" value="<?php echo $row ['EmailAddress'];?>">
</div>
</div></div>
<div class="row">
<div class="col-md-6">
...
<input class="form-control" type="text" name="phonenumber" value="<?php echo $row ['UserMobile'];?>">
</div>
</div>
...
<div class="">
<input type="text" class="form-control" id="" name="hname" value="<?php echo $row ['Hospital_Name'];?>">
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="">
<input type="text" class="form-control" id="" name="qual" value="<?php echo $row ['Qualification'];?>">
</div>
</div>
</div>
</div>
...
<div class="">
<input type="text" class="form-control" id="" name="exp" value="<?php echo $row ['Experience'];?>">
</div>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
 <label>Address</label>
<div class="">
<input type="text" class="form-control" id="" name="add" value="<?php echo $row ['Address'];?>">
</div>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
 <label>Pincode</label>
<div class="">
<input type="text" class="form-control" id="" name="pincode" value="<?php echo $row ['Pincode'];?>">
</div>
</div>
</div>
