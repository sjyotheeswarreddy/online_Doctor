...
<tbody>
                                ...
                                ?>
                                    <tr style="border-bottom: 1px solid black;">
                                        ...
                                        <td style="text-align: center;background-color:white"><?php echo $role; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $hsname; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $quali; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $exper; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $addr; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $pcode; ?></td>
...
<td style="text-align: center;width: 100%"><a href="edit-staff.php?id=<?php echo $sno; ?>" ><i class="fas fa-edit fa-2x" id="update"></i></a>
<a href="delete_staff.php?id=<?php echo $sno; ?>" ><i class="fas fa-trash fa-2x" id="delete"></i></a>
<?php 
                    if($data['status']=="1") 
  
                         echo 
"<a href=deact.php?id=".$data['id']."><i class='fas fa-solid green fa-2x fa-eye' ></i></a>";
                    else 
                        echo 
"<a href=act.php?id=".$data['id']."><i class='fas fa-solid red fa-2x fa-eye-slash' ></i></a>";
                    ?>
  </td>
...
<select  onchange="window.location='status_check.php?id='+this.value;" id="quotstatus<?php echo $i ?>">
  <option></option>
...
<!-- Mirrored from preclinic.dreamguystech.com/template/doctors.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Jun 2022 06:49:47 GMT -->
</html>