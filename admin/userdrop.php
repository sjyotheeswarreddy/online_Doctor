...
if (isset($_POST['submit'])) {
    ...
    if ($q1) {
            ...
            echo 'window.location.href="userdrop.php";';
            echo '</script>';
        } else {
            echo '<script type="text/javascript">';
...
elseif (isset($_POST['submit1'])) {
    ...
    $img='';
    $status=0;
    $q2 = mysqli_query($con, "INSERT INTO register(Username,EmailAddress,Password,UserMobile,role,Hospital_Name,Qualification,Experience,Address,Pincode,image,status) VALUES ('$Username','$EmailAddress','$Password','$UserMobile','$role','$hsname','$quali','$exper','$addr','$pcode' ,'$img','$status')");
...
elseif (isset($_POST['submit2'])) {
    ...
    $hsname='';
    $status=0;
    $q3 = mysqli_query($con, "INSERT INTO register(Username,EmailAddress,Password,UserMobile,role,Address,Pincode,Qualification,Experience,Hospital_Name,image,status) VALUES ('$Username','$EmailAddress','$Password','$UserMobile','$role','$addr','$pcode','$quali','$exper','$hsname','$img','$status')");
...
<label for="cars"  >Choose Role :</label><br>
        <select name="" id="roles" onchange="changeRole()" style="height: 40px; width:100% ; "required>
	...
	<div class="row" style="display:none;" id="staffform" >
	<div class="col-md-12">
	<div class="card-box">
	<h4 class="card-title">Add Staff</h4>
...
<div class="col-sm-6">
	<div class="form-group">
<label for="cars"  >Choose Role :</label><br>
        <select name="role" id="roles" style="height: 40px; width:100% ; " required>
        <option value="">Choose Role</option>
      	<option >Staff</option>
...
<input type="submit" name="submit"  style="color:white; background-color:#1a4780;border-radius: 20px; width: 100px;height: 40px;">
</div>
</form>
...
<div class="row" style="display:none;" id="docform">
	<div class="col-md-12">
	<div class="card-box">
...
<div class="m-t-20 text-center">
<input type="submit" name="submit1"  style="color:white; background-color:#1a4780;border-radius: 20px; width: 100px;height: 40px;">
</div>
</form>
...
<div class="m-t-20 text-center">
<input type="submit" name="submit2"  style="color:white; background-color:#1a4780;border-radius: 20px; width: 100px;height: 40px;">
</div>
</form>
...
<script>
     ...
     <script type="text/javascript">
        function changeRole() {
            ...
            var status = document.getElementById("roles").value;
            if (status == "Staff"){
