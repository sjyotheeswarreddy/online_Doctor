	...
	<li>
		<a href="prescriptionview.php"><i class="fa fa-medkit"></i> <span>Prescription Page</span></a>
		 ...
		 <li class="submenu">
			...
			<ul style="display: none;">
				<li>
					<a href="add-appointment.php"><i class="fa fa-envelope" ></i> <span class="add">Add</span></a>
					</li>
	
					<li>
						<a href="supportview.php"><i class="fa fa-eye"></i> <span class="view">view</span></a>
						</li>
 ...
 <tbody>
                                ...
                                ?>
                                    <tr style="border-bottom: 1px solid black;">
                                        ...
                                        <td style="text-align: center;background-color:white"><?php echo $Date; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $Time; ?></td>
