...
<li>
	<a href="form-horizontal.php"><i class="fa fa-medkit"></i> <span>Prescription Page</span></a>
	 </li>
...
<div class="row">
	<div class="col-md-8">
	<div class="card-box">
	<h4 class="card-title">prescription page</h4>
	<form action="#">
...
<div class="form-group row">
<label for="cars">list of medicines :</label>
<div class="col-md-9">
        <select name="role" id="roles">
        <option value="">Choose medicines</option>
        <option >Aspirin</option>
        <option >Benadryl</option>
        <option >Dolo650</option>        
        <option >Digene</option>
        </select>
</div>
		</div>
