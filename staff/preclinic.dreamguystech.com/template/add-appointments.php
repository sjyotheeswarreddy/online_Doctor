...
$sql = mysqli_query($con, "INSERT INTO  appointment(PatientName,Patient_Email,PatientPhone,Date,Time, Comments) VALUES('$Patient_Name','$Patient_Email','$PatientPn','$Date','$Time','$Message')");
if ($sql) {
