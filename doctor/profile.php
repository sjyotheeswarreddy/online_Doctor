...
<h3 class="user-name m-t-0 mb-0"><?php echo $name1?>&nbsp;<span style="font-size:15px;"><?php echo $qulif?></span></h3>
<!--<small class="text-muted">Gynecologist</small>-->
<div class="staff-id"><?php echo $role?></div><br>
<!--<div class="staff-msg"><a href="chat.html" class="btn btn-primary">Send Message</a></div>-->
<ul class="personal-info">
<li>
<span class="title">Consultation fee:</span>
<span class="text"><a href="#">&#x20b9;<?php echo $fee?></a></span>
</li>
<li>
