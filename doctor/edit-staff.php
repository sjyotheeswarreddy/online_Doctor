...
$phonenumber = mysqli_real_escape_string($con, $_POST['phonenumber']);
 ...
 $sql ="UPDATE register SET Username='$name',EmailAddress='$email',UserMobile='$phonenumber',role='$role', Hospital_Name='$hname'   WHERE id='$sno'";
...
<div class="dropdown-menu notifications" style="width: 400px; height: 600px; overflow-y: scroll;">
...
<div class="form-group">
<label>Name</label>
<input class="form-control" type="text" name="name" value="<?php echo $row2 ['Username'];?>" readonly>
</div>
</div>
...
<div class="form-group">
<label>Email</label>
<input class="form-control" type="email" name="email" value="<?php echo $row2 ['EmailAddress'];?>" readonly>
</div>
</div></div>
<div class="row">
<div class="col-md-6">
...
<input class="form-control" type="text" name="phonenumber" value="<?php echo $row2 ['UserMobile'];?>" readonly>
</div>
</div>
...
<input type="text" class="form-control" name="role" value="<?php echo $row2 ['role'];?>" readonly>
...
<div class="">
<input type="text" class="form-control" id="" name="hname" value="<?php echo $row2 ['Hospital_Name'];?>" readonly>
</div>
</div>
</div>
