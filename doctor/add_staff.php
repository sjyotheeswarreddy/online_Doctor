...
if (isset($_POST['submit'])) {
    ...
    $fee='';
    $status=0;
    $q1 = mysqli_query($con, "INSERT INTO register(Username,EmailAddress,Password,UserMobile,role,Hospital_Name,Qualification,Experience,Address,Pincode,fee,image,status) VALUES ('$Username','$EmailAddress','$Password','$UserMobile','$role','$hsname','$quali','$exper','$addr','$pcode','$fee','$img','$status')");
