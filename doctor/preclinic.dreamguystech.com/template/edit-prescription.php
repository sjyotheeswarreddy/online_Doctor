...
$phonenumber = mysqli_real_escape_string($con, $_POST['pnumber']);
 ...
 $sql ="UPDATE prescription SET PatientName='$name',Patient_Email='$email',PatientPhoneNumber='$phonenumber',Description='$message', Medicine='$medicine',Tests='$tests'  WHERE id='$sno'";
 $s=mysqli_query($con,$sql);
//header('location: appointments.php');
if ($s) {
            echo '<script type="text/javascript">';
            echo 'alert("Updated Successfully...");';
            echo 'window.location.href="prescriptionview.php";';
            echo '</script>';
        }
...
$sql = mysqli_query($con, "SELECT * from  prescription WHERE id='$sno'");
...
<input class="form-control" type="text" name="email" value="<?php echo $row ['Patient_Email'];?>" readonly>
</div>
</div>
...
<input type="text" class="form-control" name="pnumber" value="<?php echo $row ['PatientPhoneNumber'];?>" readonly>
...
<div class="">
<textarea cols="30" rows="4" class="form-control" name="message" readonly ><?php echo $row ['Description'];?></textarea>
</div>
</div>
</div>
...
<textarea cols="30" rows="4" class="form-control" name="medicine"  ><?php echo $row ['Medicine'];?></textarea>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<label>Tests</label>
<input class="form-control" type="text" name="tests" value="<?php echo $row ['Tests'];?>" >
</div>
</div>
</div>
