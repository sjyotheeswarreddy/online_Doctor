		 ...
		 <li class="submenu">
			...
			<ul style="display: none;">
				<li>
					...
					<li>
						<a href="staff.html"><i class="fa fa-eye"></i> <span>view</span></a>
						</li>
		 ...
		 <li class="submenu">
			...
			<ul style="display: none;">
				<li>
					...
					<li>
						<a href="appointmentview1.html"><i class="fa fa-eye"></i> <span>view</span></a>
						</li>
...
<div class="doc-prof">Gynecologist</div>
	...
	<a href="payment gateway\index.php" class="btn btn-primary btn-rounded float-center">Book Now</a>
