...
if (isset($_POST['submit'])) {
    ...
    $q1 = mysqli_query($con, "INSERT INTO register(Username,EmailAddress,Password,UserMobile,role,Hospital_Name,image) VALUES ('$Username','$EmailAddress','$Password','$UserMobile','$role','$hsname','$img')");
