...
<tbody>
                                ...
                                $query = mysqli_query($con, "SELECT * from  register where role='Staff'");
                                ...
                                ?>
                                    <tr style="border-bottom: 1px solid black;">
                                       ...
                                       <td style="text-align: center;"><a href="edit-staff.php?id=<?php echo $sno; ?>" ><i class="fas fa-edit fa-2x" id="update"></i></a></td>
