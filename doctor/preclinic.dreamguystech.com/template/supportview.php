	...
	<a href="index.html"><i class="fa fa-dashboard"></i> <span>USERS</span></a>
		...
		<!-- <li class="submenu">
			...
			<ul style="display: none;">
				<li>
					<a href="add_staff.html"><i class="fa fa-envelope"></i> <span>Add</span></a>
					</li>
	
					<li>
						<a href="users.html"><i class="fa fa-eye"></i> <span>view</span></a>
						</li>
...
<tbody>
                                ...
                                $query = mysqli_query($con, "SELECT * from  addsupport");
                                ...
                                ?>
                                    <tr style="border-bottom: 1px solid black;">
                                        ...
                                        <td style="text-align: center;background-color:white"><?php echo $Problemtype; ?></td>
                                        <td style="text-align: center;background-color:white"><?php echo $desc; ?></td>
                                  <td style="text-align: center;background-color:white">
                                     <img src="<?php echo $image; ?>" style="width: 50px;height: 50px; border-radius: 50%;"></td>
                                        
<td class="text-center">
<div class="dropdown action-label">


<select  onchange="window.location='status_check1.php?id='+this.value;" id="quotstatus<?php echo $i ?>">
  <option></option>
...
<!--<td class="text-center">
                                     ...
                                     <!--  <td ><a href="edit-appointment.php?id=<?php echo $sno; ?>" ><i class="fas fa-edit fa-2x" id="update"></i></a>
