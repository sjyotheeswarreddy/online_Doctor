...
<div class="form-group">
<label>Name</label>
<input class="form-control" type="text" name="name" value="<?php echo $row ['Username'];?>" readonly>
</div>
</div>
...
<div class="form-group">
<label>Email</label>
<input class="form-control" type="email" name="email" value="<?php echo $row ['EmailAddress'];?>" readonly>
</div>
</div></div>
<div class="row">
<div class="col-md-6">
...
<input class="form-control" type="text" name="phonenumber" value="<?php echo $row ['UserMobile'];?>" readonly>
</div>
</div>
...
<div class="">
<input type="text" class="form-control" id="" name="hname" value="<?php echo $row ['Hospital_Name'];?>" readonly>
</div>
</div>
</div>
