...
$role = $res['role'];
$img=$res['image'];
$qulif=$res['Qualification'];
$fee=$res['fee'];


 if (isset($_POST['btn'])) {
 $name = mysqli_real_escape_string($con,$_POST['name']);
 $qulif1 = mysqli_real_escape_string($con, $_POST['qulif']);
 $email = mysqli_real_escape_string($con, $_POST['email']);
 $fee1 = mysqli_real_escape_string($con, $_POST['fee']);
$phonenumber = mysqli_real_escape_string($con, $_POST['phonenumber']);
 ...
 $sql ="UPDATE register SET  Username='$name',Qualification='$qulif1',EmailAddress='$email',fee='$fee1',UserMobile='$phonenumber',role='$role',image='$folder'  WHERE Username='$admin'";
...
<div class="media">
<span class="avatar">
<img alt="Doctor" src="assets/img/user.jpg" class="img-fluid">
</span>
<div class="media-body">    
...
<input type="text" class="form-control " name="qulif" value="<?php echo $qulif?>">
</div>
</div>
<div class="col-md-6">
<div class="form-group ">
...
<div class="col-md-6">
<div class="form-group ">
<label class="focus-label">Consultation fee</label>
